...
namespace PlainElastic.Net.Tests.Integration.Connection
{
    ...
    class When_invalid_GET_request_on_valid_ES_instance
    {
        ...
        It should_throw_OperationException = () => exception.ShouldBeOfExactType(typeof(OperationException));
        ...
        It should_throw_exception_with_inner_WebException = () => exception.InnerException.ShouldBeOfExactType(typeof(WebException));
